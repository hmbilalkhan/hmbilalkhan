...
{   char c;
    ...
    cout<<" step 2 : Please press a to order veg items from the menu :)\n "<<endl;
    cout<<" step 3 : Please press b to order nonVeg items from the menu :)\n "<<endl;
    cout<<" step 4 : Please press c to order Drink and chai items from the menu :)\n "<<endl;
    cout<<" step 5 : Please press d to order Roti items from the menu :)\n "<<endl;
    cout<<" step 6 : Please press e to order Dessert items from the menu :)\n "<<endl;
    ...
    if(c=='s' || c=='S'){
      ...
      cout<<" Please enter your choice "<<endl;
       cout<<" (a): Veg items     ::::     (b):NonVeg items \n"<<endl;
       cout<<" * * * * * * * * * * * * * * * * * * * * * * * "<<endl;
       cout<<" (c): Drinks and chai  :::: (d) :  Roti \n "<<endl;
       cout<<" * * * * * * * * * * * * * * * * * * * * "<<endl;
       cout<<"             (e): Desserts "<<endl;
       cout<<" Enter option : ";
